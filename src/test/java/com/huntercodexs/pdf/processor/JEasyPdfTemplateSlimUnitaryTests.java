...
public class JEasyPdfTemplateSlimUnitaryTests {
    ...
    private SlimDataContent slimData() {
        ...
        settings.setLeftImagePaths(new String[]{
                "./src/test/resources/files/images/ads/logo-tester.png",
                "./src/test/resources/files/images/ads/java.png",
                "./src/test/resources/files/images/ads/java.png",
                "./src/test/resources/files/images/ads/java.png",
                "./src/test/resources/files/images/ads/java.png"
        });
    ...
    public void templateTest() {
        ...
        Assertions.assertEquals("SLIM", template);
    }
