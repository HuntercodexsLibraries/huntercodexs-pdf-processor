...
public class JEasyPdfTemplateTripleFallUnitaryTests {

    private final static String path = "./src/test/resources/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-jeasypdf-test-template-triple-fall-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-jeasypdf-test-template-triple-fall-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-jeasypdf-test-template-triple-fall-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-jeasypdf-test-template-triple-fall-A4-LAYOUT.pdf";
    ...
    private JEasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(JEasyPdfTemplates.TRIPLE_FALL);
    ...
    public void templateTest() {
        String template = template(JEasyPdfTemplates.TRIPLE_FALL);
        Assertions.assertEquals("TRIPLE_FALL", template);
    }
