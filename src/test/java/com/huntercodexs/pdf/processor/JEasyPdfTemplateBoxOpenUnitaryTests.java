...
public class JEasyPdfTemplateBoxOpenUnitaryTests {

    private final static String path = "./src/test/resources/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-jeasypdf-test-template-box-open-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-jeasypdf-test-template-box-open-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-jeasypdf-test-template-box-open-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-jeasypdf-test-template-box-open-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/files/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/files/images/background/jeasypdf-background-sample-3.jpg";
    ...
    private JEasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(JEasyPdfTemplates.BOX_OPEN);
    ...
    public void templateTest() {
        String template = template(JEasyPdfTemplates.BOX_OPEN);
        Assertions.assertEquals("BOX_OPEN", template);
    }
