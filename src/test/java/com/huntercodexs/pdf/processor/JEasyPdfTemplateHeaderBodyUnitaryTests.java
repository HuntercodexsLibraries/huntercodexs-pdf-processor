package com.huntercodexs.pdf.processor;

import com.huntercodexs.pdf.processor.core.dto.*;
import com.huntercodexs.pdf.processor.core.enumerator.*;
import com.huntercodexs.pdf.processor.template.JEasyPdfTemplate;
import com.huntercodexs.pdf.processor.template.setting.JEasyPdfTemplateSettings;
...
import static com.huntercodexs.pdf.processor.core.enumerator.JEasyPdfTemplates.template;

public class JEasyPdfTemplateHeaderBodyUnitaryTests {

    private final static String path = "./src/test/resources/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-jeasypdf-test-template-header-body-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-jeasypdf-test-template-header-body-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-jeasypdf-test-template-header-body-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-jeasypdf-test-template-header-body-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/files/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/files/images/background/jeasypdf-background-sample-1.jpg";
    ...
    private JEasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(JEasyPdfTemplates.HEADER_BODY);
    ...
    public void templateTest() {
        String template = template(JEasyPdfTemplates.HEADER_BODY);
        Assertions.assertEquals("HEADER_BODY", template);
    }
