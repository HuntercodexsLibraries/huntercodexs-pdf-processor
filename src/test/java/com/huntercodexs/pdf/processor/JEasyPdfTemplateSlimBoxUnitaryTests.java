...
public class JEasyPdfTemplateSlimBoxUnitaryTests {

    private final static String path = "./src/test/resources/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-jeasypdf-test-template-slim-box-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-jeasypdf-test-template-slim-box-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-jeasypdf-test-template-slim-box-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-jeasypdf-test-template-slim-box-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/files/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/files/images/background/jeasypdf-background-sample-4.jpg";
    ...
    private JEasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(JEasyPdfTemplates.SLIM_BOX);
    ...
    public void templateTest() {
        String template = template(JEasyPdfTemplates.SLIM_BOX);
        Assertions.assertEquals("SLIM_BOX", template);
    }
