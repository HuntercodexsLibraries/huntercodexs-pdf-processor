package com.huntercodexs.pdf.processor.template;

import com.huntercodexs.pdf.processor.core.dto.JEasyPdfContainer;
import com.huntercodexs.pdf.processor.core.dto.JEasyPdfPage;
...
import static com.huntercodexs.pdf.processor.template.setting.free.FreeTemplateSettings.*;
 ...
 * */
public class JEasyPdfFreeTemplate extends JEasyPdfBuilderTemplate {
    ...
    private void drawTemplateTitle(PDPageContentStream contentStream) {
        try {
            ...
            contentStreamText("Free", this.jeasyPdfPage, contentStream);
    ...
    private void freeContainerBackgroundCreate(
            PDDocument document,
            JEasyPdfTemplateSettings settings,
            PDPageContentStream contentStream
    ) {
    ...
    private void freeContainerCreate(
            JEasyPdfTemplateSettings settings,
            PDPageContentStream contentStream
    ) {
