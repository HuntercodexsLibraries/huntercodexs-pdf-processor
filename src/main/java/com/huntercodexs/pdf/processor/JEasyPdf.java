...
import com.huntercodexs.pdf.processor.barcode.JEasyBarcodeScanner;
import com.huntercodexs.pdf.processor.barcode.setting.BarcodeScanner;
import com.huntercodexs.pdf.processor.core.JEasyPdfResources;
...
public class JEasyPdf extends JEasyPdfResources {
    ...
    public void pdfAddForm(
        ...
        try (PDDocument document = PDDocument.load(file, docSettings.getOwnerPassword())) {
            ...
            contentStream.close();
            document.setAllSecurityToBeRemoved(nonNull(docSettings.getOwnerPassword()));
            document.save(docSettings.getFilenamePath());
            document.close();
